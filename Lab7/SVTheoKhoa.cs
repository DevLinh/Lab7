...
namespace Lab7
{
    public partial class frmSVTheoKhoa : Form
    {
        ...
        private void BtnShow_Click(object sender, EventArgs e)
        {
            ...
            str = string.Format("Select MaSo as [Mã Số], HoTen as [Họ và Tên], NgaySinh as [Ngày Sinh], GioiTinh as [Giới Tính] From SinhVien, Khoa where [SinhVien].Makhoa = [Khoa].MaKhoa and TenKhoa like N'{0}'", comboBox1.Text);
